...
function checkAnswers() {
    var openSourceCorrect = ["linux", "firefox", "gimp"];
    var proprietaryCorrect = ["windows", "macos", "adobe-photoshop"];
    ...
    if (openSourceMatches === openSourceCorrect.length && proprietaryMatches === proprietaryCorrect.length) {
        resultMessage.textContent = "Congratulations! You have successfully matched all software correctly!";
